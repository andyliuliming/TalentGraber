...
namespace Macrodeek.StarDustProductService.Controllers
{
    ...
    builder.EntitySet<AzureImage>("GithubAccounts");
    config.Routes.MapODataServiceRoute("odata", "odata", builder.GetEdmModel());
    */
    public class GithubAccountsController : GoldODataController
    {
        // GET: odata/GithubAccounts
        // the format of the query could be 
        // odata/GithubAccounts?$FileName=a.jpg&$Tag=small1
        // odata/GithubAccounts?$FileName=b.jpg&$Tag=watermark1
        [MacroDeekAuthorize]
        public async Task<IHttpActionResult> GetGithubAccounts(ODataQueryOptions<GithubAccount> queryOptions)
        {
            return Ok<IEnumerable<GithubAccount>>((IQueryable<GithubAccount>)queryOptions.ApplyTo(db.GithubAccounts));
        }
